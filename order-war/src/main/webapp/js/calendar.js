...
//	written	by Gong Tao	on 2 Dec 2001
//	last updated 20 June 2003
//	email :	gy3z@163.com
//	<form name="form1" method="post" action="">
//	  <input name="datetime" type="text" id="datetime" onclick="popUpCalendar(this, form1.datetime, 'yyyy-mm-dd')">
//	</form>
	...
	var imgDir = "CalenderImages/"			// directory for images ... e.g. var imgDir="/img/"
   ...
   function WeekNbr(n) {
	...
	function constructCalendar () {
		...
		sHTML =	"<table	 border=0 style='font-family:Courier New;font-size:11px;'><tr>"
	...
	function popUpCalendar(imgObj,	inputBox, format) {
		var	leftpos=0
		var	toppos=0
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
				...
				{
					// use user's date
					aData =	inputBox.value.split(formatChar)
				...
				crossobj.left =	fixedX==-1 ? imgObj.offsetLeft	+ leftpos :	fixedX
				crossobj.top = fixedY==-1 ?	imgObj.offsetTop +	toppos + imgObj.offsetHeight +	2 :	fixedY
			...
			{
				hideCalendar()
				if (ctlNow!=imgObj) {popUpCalendar(imgObj, inputBox, format)}
			}
			ctlNow = imgObj
		}
	}
